...
<html lang="fr">
    ...
    <body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="./deconnexion.php"><i class="fas fa-sign-out-alt"></i>Déconnexion</a></li>
                    </ul>
                </div>
            </nav>
        </header>
        <div class="container">
            <h1>Déconnexion</h1>
            <p>Vous allez vous déconnecter, veuillez retourner à la page d'accueil</p>
