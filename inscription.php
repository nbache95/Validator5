	...
	<body>
		...
		<form>
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" id="societe" aria-describedby="annotation" placeholder="Entrez le nom de votre société">
			...
			<div class="form-group">
				...
				<input type="password" class="form-control" id="mdpCheck" placeholder="Entrez le même mot de passe">
			</div>
