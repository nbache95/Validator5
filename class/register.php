	...
	*/
	public function add_user()
	{
		...
		if ($this->pass1 == $this->pass2) 
		{
			...
			//echo ("------mdp----".$pass); 
			$query = "INSERT INTO users (nom_users, prenom_users, pwd, mail_users, societe) VALUES ('$this->name', '$this->surname', '$pass', '$this->email', '$this->society')"; 
			//echo ($query);
		...
		else
		{
			...
			header("location:inscription.php?fpass='true'");
		}
	}
}
?>